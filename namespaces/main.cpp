...
using namespace std;
// To remove the jumpingcpp:: before vectorOfInt it would be sufficient to do:
// using namespace jumpingcpp;
...
int main () {
    ...
    jumpingcpp::vectorOfInt v1(dim);
    jumpingcpp::vectorOfInt *v1p = new jumpingcpp::vectorOfInt(dim);
    // copy operator (the compiler understands)
    jumpingcpp::vectorOfInt v2 = v1;
    // assignment operator
    jumpingcpp::vectorOfInt v3;
    v3 = v1;
    // copy operator
    jumpingcpp::vectorOfInt v4(v1);
