...
struct Board {
    ...
    char** makeMove(int x, int y, char symbol);
...
char** Board::makeMove (int x, int y, char symbol) {
...
char** Board::initializeBoard (int rows, int cols) {
    board = new char*[rows];
...
int main () {
    ...
    b.board = b.initializeBoard(rows, cols);

    cout << "The board is now empty: " << "\n";
    b.displayBoard();
